...
def test_add_disc_flow_propagates_invalid_current_tag_state():
    controller = build_controller()
    controller.resolve_tag_id.execute.side_effect = ValueError("Current tag is already in the library.")
